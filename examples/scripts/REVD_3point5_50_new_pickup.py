...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_REVD_3point5_50_new_pickup'
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/REVD_3point5_50_new_pickup", None, ds_prior_X, "0007.nc")
    print(DA.ds_subset_costs["fc"].data[0])
    Omega_misfit_sa, Y_misfit_sa, Q_misfit_sa, MQ_misfit_sa, U_misfit_sa, Lambda_misfit_sa, S_misfit_sa = DA.revd(1000, 5, mode = "misfit_prior_precond", str_pass = "single_approx", output_freq = 5)
