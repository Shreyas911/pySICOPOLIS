...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_ABZ_constrained_1'
    ...
    dict_masks_observables = {"H": 4.0*mask_BM5*H_uncert_data**(-2),
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_ABZ_constrained_1", 1000, None, "0006.nc")
