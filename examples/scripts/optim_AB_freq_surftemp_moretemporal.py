...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_AB_freq_surftemp_moretemporal'
    ...
    list_fields_to_ignore = ["xx_c_slide_init", "xx_c_dis_da", "xx_q_geo", "xx_gamma_s",
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_AB_freq_surftemp_moretemporal", None, ds_prior_X, "0006.nc")
