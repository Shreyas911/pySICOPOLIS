...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_ABZ_constrained_reduced'
    ...
    dict_masks_observables = {"H": mask_BM5*H_uncert_data**(-2),
                              ...
                              "age_c": mask_age_c*(age_c_uncert_data*year2sec)**(-2)/25.0,
                              "V_da_dummy2d": 25.0*V_uncert_dummy2d_data**(-2)/((IMAX + 1)*(JMAX + 1))}
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_ABZ_constrained_reduced", 1000, None, "0006.nc")
