...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_REVD_3point5_50_new_pickup_dp'
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_50_new_pickup/inexact_gn_hessian_cg/state_GNHessCG_iter_29.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/REVD_3point5_50_new_pickup_dp", None, ds_prior_X, "0007.nc")
    print(DA.ds_subset_costs["fc"].data[0])
    Omega_misfit_dp, Y_misfit_dp, Q_misfit_dp, MQ_misfit_dp, U_misfit_dp, Lambda_misfit_dp, S_misfit_dp = DA.revd(1000, 5, mode = "misfit_prior_precond", str_pass = "double_precise", output_freq = 5)
