...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_AB_freq_surftemp_onlytemporal_4'
    ...
    list_fields_to_ignore = ["xx_c_slide_init", "xx_delta_tda_const", "xx_q_geo",
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_AB_freq_surftemp_onlytemporal_4", None, ds_prior_X, "0006.nc")
