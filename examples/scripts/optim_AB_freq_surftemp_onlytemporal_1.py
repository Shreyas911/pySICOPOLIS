...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_AB_freq_surftemp_onlytemporal_1'
    ...
    list_fields_to_ignore = ["xx_c_slide_init", "xx_delta_tda_const", "xx_c_dis_da", "xx_q_geo", "xx_gamma_s",
                             "xx_s_stat", "xx_beta1", "xx_beta2", "xx_Pmax",
                             "xx_mu", "xx_RHO_A", "xx_time_lag_asth", "xx_flex_rig_lith", 
                             "xx_zs", "xx_zl", "xx_temp_c", "xx_omega_c", 
                             "xx_age_c", "xx_temp_r"]
    
    MAX_ITERS_SOR = 100
    OMEGA_SOR = 1.5

    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_AB_freq_surftemp/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_AB_freq_surftemp_onlytemporal_1", None, ds_prior_X, "0006.nc")
