...
if __name__ == "__main__":
    ...
    vx_uncert_data = surfvel_data_40kms["vx_uncert_50"].data
    vy_uncert_data = surfvel_data_40kms["vy_uncert_50"].data

    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_SVC_3point5_50_pickup'
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_50/inexact_gn_hessian_cg/state_GNHessCG_iter_2.nc")
    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_50/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_SVC_3point5_50_pickup", None, ds_prior_X)
