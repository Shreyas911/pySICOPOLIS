...
if __name__ == "__main__":
    ...
    vx_uncert_data = surfvel_data_40kms["vx_uncert_modelnotscaled"].data
    vy_uncert_data = surfvel_data_40kms["vy_uncert_modelnotscaled"].data

    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_SVC_3point5_modelnotscaled_pickup'
    ...
    dict_prior_deltas = {"xx_c_slide_init": 10.0**(-3.5),
                         "xx_q_geo": 10.0**(-3.5),
                         "xx_p_weert": 1.0,
                         "xx_q_weert": 1.0,
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_modelnotscaled/inexact_gn_hessian_cg/state_GNHessCG_iter_2.nc")
    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_modelnotscaled/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_SVC_3point5_modelnotscaled_pickup", None, ds_prior_X)

    ds = DA.inexact_gn_hessian_cg(MAX_ITERS = 100, init_alpha_cg = 0.125, min_alpha_cg_tol = 1.e-20, init_alpha_gd = 1.e-6, min_alpha_gd_tol = 1.e-20)
