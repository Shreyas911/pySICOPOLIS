...
if __name__ == "__main__":
    ...
    V_uncert_dummy2d_data = H_data_40["V_uncert_modified_dummy2d"].data
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_ABZ_modified_constrained_noic'
    ...
    list_fields_to_ignore = ["xx_c_slide_init", "xx_q_geo", "xx_zl", "xx_zs", "xx_temp_c", "xx_omega_c", "xx_temp_r"]
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_ABZ_modified_constrained_noic", 1000, None, "0006.nc")
