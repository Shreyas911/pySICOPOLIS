...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_AB_freq_noage_100_pickup'
    ...
    list_fields_to_ignore = ["xx_c_slide_init", "xx_q_geo", "xx_RHO_A", "xx_time_lag_asth", "xx_flex_rig_lith", "xx_zl", "xx_temp_r"]
    
    MAX_ITERS_SOR = 100
    OMEGA_SOR = 1.5

    ds_state = xr.open_dataset("/scratch2/shreyas/optim_AB_freq_noage_100/inexact_gn_hessian_cg/state_GNHessCG_iter_14.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_AB_freq_noage_100_pickup", 5000, None, "0006.nc")
