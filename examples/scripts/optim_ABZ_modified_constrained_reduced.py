...
if __name__ == "__main__":
    ...
    H_uncert_data = H_data_40["H_uncert_modified"].data
    V_uncert_dummy2d_data = H_data_40["V_uncert_dummy2d"].data
    zl_uncert_data = H_data_40["zl_uncert_modified"].data
    ...
    mask_BM5 = (H_data >= 2000.0)*1.0

    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_ABZ_modified_constrained_reduced'
    ...
    ds_state_phaseI = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_80_pickup/inexact_gn_hessian_cg/state_GNHessCG_iter_10.nc")
    ...
    dict_masks_observables = {"H": mask_BM5*H_uncert_data**(-2),
                              "zl": mask_BM5*zl_uncert_data**(-2),
                              "age_c": mask_age_c*(age_c_uncert_data*year2sec)**(-2)/4.0,
                              "V_da_dummy2d": 100.0*V_uncert_dummy2d_data**(-2)/((IMAX + 1)*(JMAX + 1))}
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_ABZ_modified_constrained_reduced", 1000, None, "0006.nc")
