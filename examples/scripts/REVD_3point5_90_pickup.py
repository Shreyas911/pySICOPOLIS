...
if __name__ == "__main__":
    ...
    vx_uncert_data = surfvel_data_40kms["vx_uncert_90"].data
    vy_uncert_data = surfvel_data_40kms["vy_uncert_90"].data

    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_REVD_3point5_90_pickup'
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_90_pickup/inexact_gn_hessian_cg/state_GNHessCG_iter_25.nc")
    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_90/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/REVD_3point5_90_pickup", None, ds_prior_X)
    print(DA.ds_subset_costs["fc"].data[0])
    Omega_misfit_sa, Y_misfit_sa, Q_misfit_sa, MQ_misfit_sa, U_misfit_sa, Lambda_misfit_sa, S_misfit_sa = DA.revd(1000, 2, mode = "misfit_prior_precond", str_pass = "single_approx", output_freq = 3)
