...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_REVD_3point5_90_new_pickup'
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_90_new_pickup/inexact_gn_hessian_cg/state_GNHessCG_iter_25.nc")
    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_SVC_3point5_90_new/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/REVD_3point5_90_new_pickup", None, ds_prior_X, "0007.nc")
