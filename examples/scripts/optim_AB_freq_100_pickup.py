...
if __name__ == "__main__":
    ...
    sicopolis_dir = '/home/shreyas/update_to_develop_sicopolis/sicopolis_optim_AB_freq_100_pickup'
    ...
    ds_state = xr.open_dataset("/scratch2/shreyas/optim_AB_freq_100/inexact_gn_hessian_cg/state_GNHessCG_iter_19.nc")
    ds_prior_X = xr.open_dataset("/scratch2/shreyas/optim_AB_freq_100/prior_X.nc")
    ...
    DA = optim.DataAssimilation(sicopolis_dir, simulation,
                                ...
                                MAX_ITERS_SOR, OMEGA_SOR, list_fields_to_ignore, False, None, "/scratch2/shreyas/optim_AB_freq_100_pickup", None, ds_prior_X, "0006.nc")
